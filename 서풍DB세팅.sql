...
CREATE TABLE "TB_REC_RECOMMEND" (
	"USER_NO"	NUMBER		NOT NULL,
	"RECOMMEND_NO"	NUMBER		NOT NULL
);

COMMENT ON COLUMN "TB_REC_RECOMMEND"."USER_NO" IS '회원번호';

COMMENT ON COLUMN "TB_REC_RECOMMEND"."RECOMMEND_NO" IS '추천코스 글번호';
...
ALTER TABLE "TB_REC_RECOMMEND" ADD CONSTRAINT "PK_TB_REC_RECOMMEND" PRIMARY KEY (
	"USER_NO",
	"RECOMMEND_NO"
);

ALTER TABLE "TB_REC_RECOMMEND" ADD FOREIGN KEY (
	"USER_NO"
)
