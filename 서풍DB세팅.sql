...
CREATE TABLE "TB_COMMUNITY" (
    ...
    "COMMUNITY_COMMENT" NUMBER  DEFAULT 0   NULL
);
...
COMMENT ON COLUMN "TB_COMMUNITY"."COMMUNITY_COMMENT" IS '커뮤니티 댓글수';
...
CREATE TABLE "TB_PLAN_MAP" (
	...
	"PLAN_DAY"	NUMBER		NOT NULL,
	"PLAN_PLACE"	VARCHAR2(300)		NULL,
	"PLAN_NO"	NUMBER		NOT NULL
);

COMMENT ON COLUMN "TB_PLAN_MAP"."PLAN_MAP_NO" IS '일정 장소 번호';

COMMENT ON COLUMN "TB_PLAN_MAP"."PLAN_DAY" IS 'day1, day2';

COMMENT ON COLUMN "TB_PLAN_MAP"."PLAN_PLACE" IS '작성자가 생성한 장소이름';
