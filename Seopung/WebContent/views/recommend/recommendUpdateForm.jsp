<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="com.kh.recommend.model.vo.*"%>
<%
	...
	<div class="container-fluid">
		...
		<div class="outer">
			...
			<form action="<%=contextPath%>/update.re" method="post" enctype="multipart/form-data">
				...
				<!-- 수정 필요! 임시 -->
				<input type="hidden" name ="cno" value="<%=nc.getReNo()%>">
				
				<input type="text" name="title" style="width: 100%; margin-top:120px;"
					placeholder="제목입력" class="form-control" value="<%=nc.getTitle() %>" required> <br>
					
				<textarea  id="summernote" name="content" required><%=nc.getContent() %></textarea>

				<br>
				
				<button type="button" id="thumbBtn"
					class="btn btn-outline-secondary btn-sm">썸네일 사진첨부</button>
				<img width="140" height="140" id="thumbPreview" src="<%=nc.getThumb() %>" > 
