		...
		<div class="outer" align="left">
			<form action="" method="post" id="faqPost">
				...
				<div>
					...
					<H3>2박 3일 서울투어</H3>
					<h6>2020.09.09 조회수 54</h6>

					<hr>

					<h6>2박 3일 서울 투어에 대한 질문입니다. <br>
						서풍 홈페이지에서 투어의 기본 지식과 
						서울 투어의 좋은 팁을 알고 싶은데 어디에서 찾을 수 있나요?</h6>
					...
					<h6>A.<br>
						...
						위하여서 그리하였는가? 아니다 그들은 커다란 이상 곧 만천하의 대중을 
						품에 안고 그들에게 밝은 길을 찾아 주며 그들을
					</h6>
