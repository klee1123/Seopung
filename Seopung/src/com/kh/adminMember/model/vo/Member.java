...
public class Member {
	...
	public Member(int userNo, String userId, String userName, Date enrollDate, Date modifyDate, String status) {
		super();
		this.userNo = userNo;
		this.userId = userId;
		this.userName = userName;
	...
	public Member(int userNo, String userId, String userName, String nickName, String birth, String gender,
			String phone, String email, Date enrollDate, Date modifyDate, String userIntro, String profile,
			String status) {
		super();
		this.userNo = userNo;
		this.userId = userId;
