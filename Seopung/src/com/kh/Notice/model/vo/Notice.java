...
public class Notice {
	...
	public Notice(String noticeContent, Date noticeEnroll, int noticeNo, String noticeTitle, int noticeViews,
			String noticeWriter) {
		super();
	...
	public Notice(int adminNo, String noticeContent, Date noticeEnroll, Date noticeModify, int noticeNo,
