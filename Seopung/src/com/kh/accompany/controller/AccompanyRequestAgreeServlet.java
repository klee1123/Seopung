...
/**
 * Servlet implementation class AccompanyRequestAgreeServlet
 */
@WebServlet("/agree.ac")
public class AccompanyRequestAgreeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AccompanyRequestAgreeServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new AccompanyService().agree(accomNo);
