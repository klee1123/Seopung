...
ALTER TABLE TB_REPORT ADD REPORT_POSTTYPE NUMBER NOT NULL; 

COMMENT ON COLUMN "TB_REPORT"."REPORT_POSTTYPE" IS '1:커뮤니티/2:일정/3:댓글';

ALTER TABLE TB_REPORT DROP COLUMN REPORT_CONTENT;

ALTER TABLE TB_REPORT ADD REPORT_CONTENT VARCHAR2(2000) NOT NULL;
